...
export default function Studio() {
  ...
  return <div className="site-shell" id="home" ref={shellRef}>
    ...
    <main>
      ...
      <section id="mint" className="landing-section mint-section"><div className="landing-kicker">03 / THE DOOR, WHEN IT OPENS</div><div className="mint-grid"><div><h2>Know the facts.<br/><em>Keep the wonder.</em></h2><p>Wobbleheads will mint when the official details are ready. No countdown theatre, no mystery links in the dark: this is the one place to check the current plan.</p><div className="mint-links"><a className="text-link" href="https://x.com/Wobbleheadds" target="_blank" rel="noopener noreferrer">Official updates <ArrowUpRight size={17}/></a></div></div><div className="mint-facts" aria-label="Mint information"><div><span>SUPPLY</span><strong>3,333</strong></div><div><span>NETWORK</span><strong>Robinhood</strong></div><div><span>PRICE</span><strong>TBA</strong></div><div><span>MINT DATE</span><strong>TBA</strong></div><div><span>GAME WL ALLOCATION</span><strong>{TOTAL_GAME_WL.toLocaleString()} spots</strong><small>For players who beat the game · {GTD_TOTAL.toLocaleString()} GTD · {FCFS_TOTAL.toLocaleString()} FCFS</small></div><div><span>MAX PER WALLET</span><strong>TBA</strong></div><div><span>MINT STATUS</span><strong>Not announced</strong></div><div><span>OFFICIAL LINKS</span><strong><a href="https://x.com/Wobbleheadds" target="_blank" rel="noopener noreferrer">X ↗</a></strong></div></div></div></section>
      <section id="roadmap" className="landing-section roadmap-landing"><div className="landing-kicker">04 / THE WOBBLEHEADS UNIVERSE</div><div className="roadmap-heading"><h2>First the Heads.<br/><em>Then a whole world.</em></h2><p>Every Wobblehead starts as a face with a personality. The roadmap turns that identity into a complete character built for the world ahead.</p></div><div className="landing-roadmap chapter-grid"><div><span>CHAPTER 00</span><h3>Play for Your Place</h3><p>Players enter through Downhill Wobble, chase a verified whitelist spot, share their runs, and become the first community behind the collection.</p></div><div><span>CHAPTER 01</span><h3>Mint the Heads</h3><p>3,333 one-of-one Heads arrive on Robinhood. Your face becomes your identity at the start of the Wobbleheads story.</p></div><div><span>CHAPTER 02</span><h3>Bring in the Bodies</h3><p>Head holders unlock the next collectible chapter: Bodies created to turn every floating face into a full Wobblehead.</p></div><div><span>CHAPTER 03</span><h3>Complete Your Character</h3><p>Pair Head and Body, discover the full personality, and get your Wobblehead ready for what comes next.</p></div><div><span>CHAPTER 04</span><h3>Enter the Game</h3><p>A Wobbleheads game is coming. Complete characters step off the collection page and into a world made to move, play, and wobble.</p></div></div><div className="post-mint-story"><div><span>THE BIGGER IDEA</span><h3>You are not only collecting an image. You are building a character.</h3></div><div className="post-mint-beats"><p><strong>Start with identity.</strong> Every Head carries the expression, traits, and odd personality that makes it unmistakably yours.</p><p><strong>Build the full Wobble.</strong> Bodies expand the collection and give each Head a complete character form.</p><p><strong>Get ready to play.</strong> The collection becomes the cast for an upcoming Wobbleheads game and a growing world.</p></div></div><div className="roadmap-promise"><strong>Mint the face. Build the character. Enter the game.</strong><span>Follow Wobbleheads on X for mint details, Body reveals, and game development updates.</span></div></section>
    </main>
