'use client';
/* oxlint-disable next/no-html-link-for-pages -- Sites sign-in and sign-out require top-level anchor navigation. */
...
export default function Experience() {
  ...
  return <>
    ...
    <section id="roadmap" className="world-section roadmap-section"><div className="section-head"><span>07 / THE ROAD AHEAD</span><HiddenSymbol number={7} found={found.includes(7)} onFind={find}/></div><h2>Still taking shape.</h2><div className="roadmap-grid"><div><span>01 / NOW</span><h3>Draw & discover</h3><p>Explore the collection, make your own face, and play for XP.</p></div><div><span>02 / NEXT</span><h3>Grow the world</h3><p>Community quests and WL review as official links and dates are confirmed.</p></div><div><span>03 / LATER</span><h3>More wobble</h3><p>Future details will be announced through official project channels.</p></div></div></section>
